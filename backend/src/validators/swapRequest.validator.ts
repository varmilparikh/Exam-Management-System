...
export const approveSwapRequestSchema = z
  .object({
 ...
 */
export const rejectSwapRequestSchema = z
  .object({
    reason: z
      .string()
      .trim()
 ...
 */
export const cancelSwapRequestSchema = z
  .object({
    reason: z
      .string()
      .trim()
 ...
 */
export const rejectSwapByCoeSchema = z
  .object({
    approvalRemark: z
      .string()
      .trim()
